...
export default function Home() {
  return (
    <main className="h-screen overflow-hidden bg-gradient-to-br from-white to-[#1d4268] p-4 md:p-14">
      <div className="max-w-4xl mx-auto bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg p-8 md:p-12 overflow-auto">
        <h1 className="flex justify-center text-3xl md:text-4xl font-bold text-[#041c4c] mb-6">
